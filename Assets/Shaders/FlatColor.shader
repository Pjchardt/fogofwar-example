...
//Based on shader from Alastair Aitchison: https://alastaira.wordpress.com/2014/12/30/adding-shadows-to-a-unity-vertexfragment-shader-in-7-easy-steps/

Shader "Pjchardt/FlatColor" {
    ...
    SubShader {
        Pass {
            ...
            fixed4 frag(v2f i) : COLOR {
                ...
                return attenuation * _Color +  (1 - attenuation) * _ShadowColor;
            }
